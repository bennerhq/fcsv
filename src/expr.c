...
#define TOK_BASE        (10000)
#   define TOK_COLON       (TOK_BASE + 0)
#   define TOK_LPAREN      (TOK_BASE + 1)
#   define TOK_RPAREN      (TOK_BASE + 2)
#   define TOK_TRUE        (TOK_BASE + 3)
#   define TOK_FALSE       (TOK_BASE + 4)
#   define TOK_NUMBER      (TOK_BASE + 5)
#   define TOK_ID_NAME     (TOK_BASE + 6)
#   define TOK_VAR_IDX     (TOK_BASE + 7)
#   define TOK_VAR_STR     (TOK_BASE + 8)
#   define TOK_CONDITION   (TOK_BASE + 9) 
